...
namespace Microsoft.AspNetCore.Rewrite.Tests.UrlRewrite
{
    public class InputParserTests
    {
        ...
        public void InputParser_ParseLiteralString()
        {
            ...
            var result = new InputParser().ParseInputString(testString, UriMatchCondition.UriMatchPart.Path);
        ...
        {
            var middle = new InputParser().ParseInputString(testString, UriMatchCondition.UriMatchPart.Path);
        ...
        {
            Assert.Throws<FormatException>(() => new InputParser().ParseInputString(testString, UriMatchCondition.UriMatchPart.Path));
        }
