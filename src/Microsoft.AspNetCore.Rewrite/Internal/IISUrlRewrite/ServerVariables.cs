    ...
    public static class ServerVariables
    {
        public static PatternSegment FindServerVariable(string serverVariable, ParserContext context)
        {
            switch (serverVariable)
            {
                ...
                case "ALL_RAW":
                    throw new NotSupportedException(Resources.FormatError_UnsupportedServerVariable("ALL_RAW"));
                case "APP_POOL_ID":
                    throw new NotSupportedException(Resources.FormatError_UnsupportedServerVariable("APP_POOL_ID"));
                case "CONTENT_LENGTH":
                ...
                case "HTTP_PROXY_CONNECTION":
                    throw new NotSupportedException(Resources.FormatError_UnsupportedServerVariable("HTTP_PROXY_CONNECTION"));
                case "QUERY_STRING":
